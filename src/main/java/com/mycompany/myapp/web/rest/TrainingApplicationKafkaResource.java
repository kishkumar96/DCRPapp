...
@RestController
@RequestMapping("/api/training-application-kafka")
public class TrainingApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TrainingApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TrainingApplicationKafkaResource(KafkaProperties kafkaProperties) {
