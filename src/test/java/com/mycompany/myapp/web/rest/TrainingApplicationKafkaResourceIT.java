...
class TrainingApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        TrainingApplicationKafkaResource kafkaResource = new TrainingApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/training-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/training-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
